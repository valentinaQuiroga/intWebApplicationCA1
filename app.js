...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('artGallery.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('artGallery.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        xmlFileToJs('artGallery.xml', function (err, result) {
            if (err) throw (err);
            ...
            jsToXmlFile('artGallery.xml', result, function(err){
